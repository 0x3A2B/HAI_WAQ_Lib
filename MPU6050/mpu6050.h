...
void PMU6050_ReadData(I2C_HandleTypeDef *  hi2c, uint8_t reg_add,unsigned char*Read,uint8_t num);
void PMU6050_WriteReg(I2C_HandleTypeDef *  hi2c, uint8_t reg_add,uint8_t reg_dat);

void MPU6050_PWR_MGMT_1_INIT(I2C_HandleTypeDef *  hi2c);
